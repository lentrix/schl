        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-edit"></i> Update Teacher {{$teacher->fname}}</h4>
                </div>
                {!! Form::model($teacher,['url'=>"/teachers/$teacher->id", 'method'=>'patch'])  !!}
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Update Teacher</button>
                    </div>
