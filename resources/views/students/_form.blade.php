        ...
        <div class="col-md-7">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?= Form::date('bdate',null, ['class'=>'form-control']); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <button class="btn btn-primary btn-lg pull-right" type="submit"><i class="glyphicon glyphicon-ok"></i> Submit</button>
                    </td>
                </tr>
            </table>
        </div>
